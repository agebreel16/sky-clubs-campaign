...
:root {
  --accent:  oklch(0.60 0.22 245);
  --accent2: oklch(0.50 0.22 270);
  --accent3: oklch(0.70 0.18 200);
  --accent-glow: oklch(0.60 0.22 245 / 0.35);
...
<div class="sc-page">
  ...
  {{-- BRAND PANEL (appears on RIGHT in RTL) --}}
    ...
    <div class="sc-brand-content">
      ...
      <div class="sc-brand-header">
        ...
        <div>
          ...
          <div class="sc-brand-tagline">لوحة الإدارة</div>
        </div>
  ...
  {{-- FORM PANEL (appears on LEFT in RTL) --}}
  <div class="sc-form-panel">
    ...
    >
      <div class="sc-form-header">
        ...
        <p class="sc-form-sub">الوصول إلى لوحة الإدارة</p>
      </div>
